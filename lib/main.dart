...
class _HomeState extends State<Home> {
  ...
  print(numberDigits);
    ...
    setState(() {
      if(firstCompare == newCpf[9] && secondaryCompare == newCpf[10]){
        alert = "CPF VÁLIDO";
        _message = Text(alert, style: TextStyle(color: Colors.teal, fontWeight: FontWeight.bold, fontSize: 20.0));

      }else{
        alert = "CPF INVÁLIDO";
        _message = Text(alert, style: TextStyle(color: Colors.red, fontWeight: FontWeight.bold, fontSize: 20.0));
      }
    });
  ...
  void _format(String text){
    ...
    if(_cpfController.text.length == 11){
      ...
      String digitosMask = newDigitos[0]+newDigitos[1]+newDigitos[2]+"."+newDigitos[3]+newDigitos[4]+newDigitos[5]+"."+newDigitos[6]+newDigitos[7]+newDigitos[8]+"-"+newDigitos[9]+newDigitos[10];
          ...
          child: Column(
            ...
            children: <Widget>[
              Padding(
                ...
                child: Center(
                  child: Text(_digits, style: TextStyle(color: Colors.blueAccent, fontWeight: FontWeight.bold, fontSize: 20),),
                ),
              ),
              Padding(
...
//                    helperText: "Digite apenas números",
                    helperStyle: TextStyle(color: Colors.grey, fontWeight: FontWeight.bold),
...
//                onChanged: _format,
              ...
              Padding(
                ...
                child: RaisedButton(
                  child: Text("VERIFICAR", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: 20.0),),
                  color: Colors.teal,
